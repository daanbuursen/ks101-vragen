Omdat we gisteren waarschijnlijk de fout qua inspringen niet zagen hier even een werkende sample van het wijzigen van de port/targetport op de service.
...
```
De onderste drie velden zijn belangrijk. Hierin zien we dat het een map is, dat de merge-key de port is en dat de strategie om met de map om te gaan een merge is. Daarom moeten we dus deleten.

Om ook de ServicePort te kunnen lezen (en te zien wat er dus required is):
```
